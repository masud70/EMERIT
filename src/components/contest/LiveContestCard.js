...
const LiveContestCard = () => {
    return (
        <View className='bg-slate-100 my-1 rounded p-2 space-y-3'>
            ...
            <View className='px-0'>
                <View >
                    <Progress.Bar progress={0.7} className='w-full' width={356} color={COLORS.primary}/>
                </View>
                <View className='flex flex-row justify-between'>
                    <Text className='font-bold text-green-700'>30m left</Text>
                    <Text className='font-bold'>1h 30m</Text>
                </View>
            </View>
            <View className=''>
